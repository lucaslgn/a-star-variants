...
class Node(object):
    ...
    def __init__(self, i=0, j=0):
        ...
        self.fb = inf
        self.g = inf
        self.gb = inf # variable used only in bidirectional A* search.
        self.closed = False
        self.closed_backwards = False # variable used only in bidirectional search
        self.parent = None
        self.parent_backwards = None
